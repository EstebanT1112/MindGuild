...
import { Users2, Flame, Trophy, Check, X, UserPlus } from 'lucide-react-native';
...
export default function FriendsScreen() {
  ...
  return (
    <ScreenLayout 
      title="AMIGOS" 
      type="friends" 
      icon={<Users2 color="#22c55e" size={22} />}
    >
...
const styles = StyleSheet.create({
  ...
  statsRow: { 
    ...
    marginTop: 15, backgroundColor: '#0f172a', padding: 15, borderRadius: 20 
  },
